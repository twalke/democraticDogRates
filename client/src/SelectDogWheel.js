...
class SelectDogWheel extends Component {
  render() {
    return (
      <div>
        <select id="selectBreed" className="selectMenu" onChange={(e) => this.setState({ breed: e.target.value })}>
